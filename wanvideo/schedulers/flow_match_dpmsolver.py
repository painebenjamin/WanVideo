...
__all__ = ["FlowMatchDPMSolverMultistepScheduler"]


class FlowMatchDPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    """
    `FlowMatchDPMSolverMultistepScheduler` is a fast dedicated high-order solver for diffusion ODEs.
        ...
        if self.config.algorithm_type in ["dpmsolver++", "sde-dpmsolver++"]:
            if self.config.prediction_type == "flow_prediction":
                ...
                raise ValueError(
                    ...
                    " `v_prediction`, or `flow_prediction` for the FlowMatchDPMSolverMultistepScheduler."
                )
